...
- [ ] T046 [P] [US2] Flutter integration test for register/sign-in/MFA/sessions/lifecycle in frontend/app/integration_test/us02_identity_test.dart
  - Register/sign-in scenarios written (2026-07-13); MFA/sessions/lifecycle scenarios land alongside those sub-checkpoints. Navigates directly via the router (no gated action exists yet on Discover to reach these screens through, per T043's own note).
