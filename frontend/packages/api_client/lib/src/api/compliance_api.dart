...
class ComplianceApi {
  ...
  ///
  /// Parameters:
  /// * [surface] - The surface key requesting a gate decision (e.g. \"registration\", \"recipe_detail\").
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [AgeGateResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AgeGateResponse>> getAgeGate({ 
    ...
    final _path = r'/compliance/age-gate';
    ...
    final _queryParameters = <String, dynamic>{
      r'surface': encodeQueryParameter(_serializers, surface, const FullType(String)),
    };
    ...
    AgeGateResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AgeGateResponse),
      ) as AgeGateResponse;
    ...
    return Response<AgeGateResponse>(
      data: _responseData,
  ...
  ///
  /// Parameters:
  /// * [surface] - The surface class requesting a message.
  /// * [jurisdiction] 
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ResponsibleConsumptionMessageResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ResponsibleConsumptionMessageResponse>> getResponsibleConsumptionMessage({ 
    required String surface,
    String? jurisdiction,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/compliance/messaging';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ResponsibleConsumptionMessageResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ResponsibleConsumptionMessageResponse),
      ) as ResponsibleConsumptionMessageResponse;
    ...
    return Response<ResponsibleConsumptionMessageResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [SupportResourcesResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SupportResourcesResponse>> getSupportResources({ 
    String? jurisdiction,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/compliance/support-resources';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    SupportResourcesResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(SupportResourcesResponse),
      ) as SupportResourcesResponse;
    ...
    return Response<SupportResourcesResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
