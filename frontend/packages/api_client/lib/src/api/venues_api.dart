...
class VenuesApi {
  ...
  Future<Response<Venue>> createVenue({ 
    required CreateVenueRequest createVenueRequest,
    ...
    try {
      const _type = FullType(CreateVenueRequest);
      _bodyData = _serializers.serialize(createVenueRequest, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteVenue({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/venues/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [VenuePage] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<VenuePage>> listVenues({ 
    String? cursor,
    int? limit = 20,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    VenuePage? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(VenuePage),
      ) as VenuePage;
  ...
  /// Returns a [Future] containing a [Response] with a [Venue] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Venue>> updateVenue({ 
    required String id,
    required UpdateVenueRequest updateVenueRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UpdateVenueRequest);
      _bodyData = _serializers.serialize(updateVenueRequest, specifiedType: _type);
