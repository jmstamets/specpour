...
class CatalogApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [ConceptDetail] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ConceptDetail>> getConcept({ 
    required String id,
    ...
    final _path = r'/concepts/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    ...
    ConceptDetail? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ConceptDetail),
      ) as ConceptDetail;
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [RecipeDetail] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RecipeDetail>> getRecipe({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    RecipeDetail? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RecipeDetail),
      ) as RecipeDetail;
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ConceptPage] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ConceptPage>> listConcepts({ 
    String? cursor,
    int? limit = 20,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    ConceptPage? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ConceptPage),
      ) as ConceptPage;
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [RecipePage] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RecipePage>> listRecipes({ 
    String? family,
    String? category,
    String? tag,
    ...
    final _queryParameters = <String, dynamic>{
      if (family != null) r'family': encodeQueryParameter(_serializers, family, const FullType(String)),
      ...
      if (flavorProfile != null) r'flavorProfile': encodeQueryParameter(_serializers, flavorProfile, const FullType(String)),
    ...
    RecipePage? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RecipePage),
      ) as RecipePage;
