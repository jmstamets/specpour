...
class AuthorizationApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [EntitlementManifest] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EntitlementManifest>> getMyEntitlements({ 
    ...
    EntitlementManifest? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(EntitlementManifest),
      ) as EntitlementManifest;
    ...
    return Response<EntitlementManifest>(
      data: _responseData,
