...
class InventoryApi {
  ...
  Future<Response<InventoryItem>> createInventoryItem({ 
    required CreateInventoryItemRequest createInventoryItemRequest,
    ...
    try {
      const _type = FullType(CreateInventoryItemRequest);
      _bodyData = _serializers.serialize(createInventoryItemRequest, specifiedType: _type);
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(InventoryItem),
      ) as InventoryItem;
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteInventoryItem({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/inventory/items/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [InventoryItem] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<InventoryItem>> getInventoryItem({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [MakeableResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<MakeableResponse>> getMakeableRecipes({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/inventory/makeable';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    MakeableResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(MakeableResponse),
      ) as MakeableResponse;
    ...
    return Response<MakeableResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [venueId] - When present, lists that venue's inventory instead of the caller's personal inventory (403 if the caller doesn't own it).
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [InventoryItemPage] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<InventoryItemPage>> listInventoryItems({ 
    String? venueId,
    String? cursor,
    int? limit = 20,
    CancelToken? cancelToken,
    ...
    final _queryParameters = <String, dynamic>{
      if (venueId != null) r'venueId': encodeQueryParameter(_serializers, venueId, const FullType(String)),
    ...
    InventoryItemPage? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(InventoryItemPage),
      ) as InventoryItemPage;
  ...
  /// Returns a [Future] containing a [Response] with a [InventoryItem] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<InventoryItem>> updateInventoryItem({ 
    required String id,
    ...
    try {
      const _type = FullType(UpdateInventoryItemRequest);
      _bodyData = _serializers.serialize(updateInventoryItemRequest, specifiedType: _type);
