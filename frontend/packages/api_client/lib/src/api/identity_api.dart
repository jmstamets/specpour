...
class IdentityApi {
  ...
  /// Parameters:
  /// * [provider] 
  /// * [redirectUri] - Where the browser ends up when the whole flow (including any DOB completion) is done.
  ...
  Future<Response<void>> challengeExternalSignIn({ 
    ...
    final _path = r'/auth/external/{provider}'.replaceAll('{' r'provider' '}', encodeQueryParameter(_serializers, provider, const FullType(String)).toString());
    ...
    final _queryParameters = <String, dynamic>{
      r'redirectUri': encodeQueryParameter(_serializers, redirectUri, const FullType(String)),
    };
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AuthAccount] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthAccount>> completeExternalRegistration({ 
    required CompleteExternalRegistrationRequest completeExternalRegistrationRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/auth/external/complete-registration';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(CompleteExternalRegistrationRequest);
      _bodyData = _serializers.serialize(completeExternalRegistrationRequest, specifiedType: _type);
    ...
    AuthAccount? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AuthAccount),
      ) as AuthAccount;
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> confirmAccountRecovery({ 
    required RecoveryConfirmRequest recoveryConfirmRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/auth/recovery/confirm';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(RecoveryConfirmRequest);
      _bodyData = _serializers.serialize(recoveryConfirmRequest, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deactivateMyAccount({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> disableMfa({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [MfaEnrollment] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<MfaEnrollment>> enrollOrConfirmMfa({ 
    EnrollMfaRequest? enrollMfaRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(EnrollMfaRequest);
      _bodyData = enrollMfaRequest == null ? null : _serializers.serialize(enrollMfaRequest, specifiedType: _type);
    ...
    MfaEnrollment? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(MfaEnrollment),
      ) as MfaEnrollment;
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [MeExport] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<MeExport>> exportMyAccount({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    MeExport? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(MeExport),
      ) as MeExport;
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> externalSignInCallback({ 
    required String provider,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/auth/external/{provider}/callback'.replaceAll('{' r'provider' '}', encodeQueryParameter(_serializers, provider, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SessionList>> listMySessions({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future] containing a [Response] with a [AuthAccount] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthAccount>> loginMfa({ 
    required LoginMfaRequest loginMfaRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(LoginMfaRequest);
      _bodyData = _serializers.serialize(loginMfaRequest, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> reactivateMyAccount({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future] containing a [Response] with a [AuthAccount] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthAccount>> registerAccount({ 
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> requestAccountRecovery({ 
    required RecoveryRequest recoveryRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(RecoveryRequest);
      _bodyData = _serializers.serialize(recoveryRequest, specifiedType: _type);
