...
class NotificationsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [InboxPage] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<InboxPage>> getInbox({ 
    String? cursor,
    int? limit = 20,
    ...
    InboxPage? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(InboxPage),
      ) as InboxPage;
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ChannelPreferences] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ChannelPreferences>> getMyChannelPreferences({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    ChannelPreferences? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ChannelPreferences),
    ...
    return Response<ChannelPreferences>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> markInboxMessageRead({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/inbox/{id}/read'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [ChannelPreferences] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ChannelPreferences>> updateMyChannelPreferences({ 
    required ChannelPreferencesUpdate channelPreferencesUpdate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(ChannelPreferencesUpdate);
      _bodyData = _serializers.serialize(channelPreferencesUpdate, specifiedType: _type);
