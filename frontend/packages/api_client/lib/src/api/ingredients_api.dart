...
class IngredientsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [IngredientAuthor] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<IngredientAuthor>> createIngredient({ 
    required CreateIngredientRequest createIngredientRequest,
    ...
    try {
      ...
      _bodyData = _serializers.serialize(createIngredientRequest, specifiedType: _type);
    ...
    IngredientAuthor? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(IngredientAuthor),
      ) as IngredientAuthor;
    ...
    return Response<IngredientAuthor>(
      data: _responseData,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteIngredient({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/ingredients/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [IngredientRecipes] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<IngredientRecipes>> getIngredientRecipes({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/ingredients/{id}/recipes'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    IngredientRecipes? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(IngredientRecipes),
    ...
    return Response<IngredientRecipes>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [IngredientPage] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<IngredientPage>> listIngredients({ 
    ...
    IngredientPage? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(IngredientPage),
      ) as IngredientPage;
    ...
    return Response<IngredientPage>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [IngredientAuthor] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<IngredientAuthor>> updateIngredient({ 
    required String id,
    required UpdateIngredientRequest updateIngredientRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      ...
      _bodyData = _serializers.serialize(updateIngredientRequest, specifiedType: _type);
