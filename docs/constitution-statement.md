...
- **Code quality:** Enforced formatting and static analysis in CI for both C# and Dart; peer review required for all merges; architecture decision records (ADRs) for significant decisions.
